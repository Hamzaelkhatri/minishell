...
/*   Updated: 2021/01/20 12:38:51 by zdnaya           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_list_cmd *sort_all_1(t_list_cmd *lst, t_shell *sh) {
  ...
  free_sp = shell_space_split(string, sh);
  int i = 0;

  cmd = free_sp[0];
  if (ft_strcmp(cmd, "echo") == 0 && ft_strcmp(free_sp[1], "-n") == 0) {
